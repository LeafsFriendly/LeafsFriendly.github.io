...
var matthews_auston = new Player("Auston Matthews", formatMoney(13250000), formatBonus(0), 4, "UFA", "C", matthews_auston_age, "LH", "NMC");
var tavares_john = new Player("John Tavares", formatMoney(11000000), formatBonus(0), 1, "UFA", "C", tavares_john_age, "LH", "NMC");
var nylander_william = new Player("William Nylander", formatMoney(11500000), formatBonus(0), 8, "UFA", "RW", nylander_william_age, "RH", "NMC");
var marner_mitchell = new Player("Mitchell Marner", formatMoney(10903000), formatBonus(0), 1, "UFA", "RW", marner_mitch_age, "RH", "NMC");
var kampf_david = new Player("David Kampf", formatMoney(2400000), formatBonus(0), 3, "UFA", "C", kampf_david_age, "LH", "M-NTC");
var jarnkrok_calle = new Player("Calle Jarnkrok", formatMoney(2100000), formatBonus(0), 2, "UFA", "RW", jarnkrok_calle_age, "RH", "M-NTC");
var reaves_ryan = new Player("Ryan Reaves", formatMoney(1350000), formatBonus(0), 2, "UFA", "RW", reaves_ryan_age, "RH", "None");
var mcmann_bobby = new Player("Bobby McMann", formatMoney(1350000), formatBonus(0), 2, "UFA", "LW", mcmann_bobby_age, "LH", "None");
var knies_matthew = new Player("Matthew Knies", formatMoney(925000), formatBonus(0), 1, "RFA", "LW", knies_matthew_age, "LH", "None");
var holmberg_pontus = new Player("Pontus Holmberg", formatMoney(800000), formatBonus(0), 1, "RFA (Arb)", "C", holmberg_pontus_age, "LH", "None");
var cowan_easton = new Player("Easton Cowan", formatMoney(904667), formatBonus(0), 3, "RFA", "LW", cowan_easton_age, "LH", "None");
var minten_fraser = new Player("Fraser Minten", formatMoney(816667), formatBonus(0), 3, "RFA", "C", minten_fraser_age, "LH", "None");
...
var hirvonen_roni = new Player("Roni Hirvonen", formatMoney(856667), formatBonus(0), 1, "RFA", "LW", hirvonen_roni_age, "LH", "None");
var quillan_jacob = new Player("Jacob Quillan", formatMoney(875000), formatBonus(0), 2, "RFA", "C", quillan_jacob_age, "LH", "None");
...
var benoit_simon = new Player("Simon Benoit", formatMoney(1350000), formatBonus(0), 3, "UFA", "LD", benoit_simon_age, "LH", "None");
var timmins_conor = new Player("Conor Timmins", formatMoney(1100000), formatBonus(0), 1, "RFA (Arb)", "RD", timmins_conor_age, "RH", "None");
var webber_cade = new Player("Cade Webber", formatMoney(875000), formatBonus(0), 1, "10.2c", "LD", webber_cade_age, "LH", "None");
var niemela_topi = new Player("Topi Niemela", formatMoney(856667), formatBonus(0), 1, "RFA", "RD", niemela_topi_age, "RH", "None");
var rifai_marshall = new Player("Marshall Rifai", formatMoney(775000), formatBonus(0), 1, "UFA", "LD", rifai_marshall_age, "LH", "None");
var mattinen_nicolas = new Player("Nicolas Mattinen", formatMoney(775000), formatBonus(0), 1, "UFA", "RD", mattinen_nicolas_age, "RH", "None");
var villeneuve_william = new Player("William Villeneuve", formatMoney(817778), formatBonus(0), 1, "RFA", "RD", villeneuve_william_age, "RH", "None");
var kokkonen_mikko = new Player("Mikko Kokkonen", formatMoney(846667), formatBonus(0), 1, "RFA", "LD", kokkonen_mikko_age, "LH", "None");
var chadwick_noah = new Player("Noah Chadwick", formatMoney(826111), formatBonus(0), 3, "RFA", "LD", chadwick_noah_age, "LH", "None");
var liljegren_timothy = new Player("Timothy Liljegren", formatMoney(3000000), formatBonus(0), 2, "UFA", "RD", liljegren_timothy_age, "RH", "None");
var ekman_larsson_oliver = new Player("Oliver Ekman-Larsson", formatMoney(3500000), formatBonus(0), 4, "UFA", "LD", ekman_larsson_oliver_age, "LH", "M-NTC");
var tanev_christopher = new Player("Christopher Tanev", formatMoney(4500000), formatBonus(0), 6, "UFA", "RD", tanev_christopher_age, "RH", "NMC");
...
var hildeby_dennis = new Player("Dennis Hildeby", formatMoney(843333), formatBonus(0), 1, "RFA", "G", hildeby_dennis_age, "LH", "None");
var akhtiamov_artur = new Player("Artur Akhtiamov", formatMoney(851667), formatBonus(0), 2, "RFA", "G", akhtiamov_artur_age, "LH", "None");
var peksa_vyacheslav = new Player("Vyacheslav Peksa", formatMoney(851667), formatBonus(0), 2, "RFA", "G", peksa_vyacheslav_age, "LH", "None");
var murray_matt = new Player("Matt Murray", formatMoney(875000), formatBonus(0), 1, "UFA", "G", murray_matt_age, "LH", "None");
var stolarz_anthony = new Player("Anthony Stolarz", formatMoney(2500000), formatBonus(0), 2, "UFA", "G", stolarz_anthony_age, "LH", "None");
